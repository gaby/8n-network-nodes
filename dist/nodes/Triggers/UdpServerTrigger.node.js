...
class UdpServerTrigger {
    constructor() {
        this.description = {
            ...
            description: "Start a UDP server and trigger workflow when data is received",
            defaults: {
    ...
    async trigger() {
        ...
        const helperOverrides = (_a = this.helpers) === null || _a === void 0 ? void 0 : _a.udpServerTrigger;
        ...
        try {
            ...
            server.on("message", (data, rinfo) => {
                ...
                if (sendResponse) {
                    ...
                    server.send(responseBuffer, 0, responseBuffer.length, rinfo.port, rinfo.address, (error) => {
                        if (error) {
            ...
            server.on("error", (error) => {
                ...
                throw new n8n_workflow_1.NodeOperationError(this.getNode(), `UDP Server Error: ${error.message}`);
            });
            server.on("listening", () => {
                const address = server.address();
                console.log(`UDP Server listening on ${address === null || address === void 0 ? void 0 : address.address}:${address === null || address === void 0 ? void 0 : address.port}`);
            });
