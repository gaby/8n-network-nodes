...
export declare function sendUdpData(host: string, port: number, message: string, waitForResponse: boolean, responseTimeout: number, encoding: BufferEncoding, dependencies?: UdpClientTransportDependencies): Promise<IDataObject>;
